...
export default function ColumnsTable(props: {
  ...
  const { columnsData, tableData, sync, isResponse } = props
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Button variant="brand" onClick={sync} isDisabled={isResponse}>
            {isResponse && <Spinner mr="2" size="sm" />}Sync Now
          </Button>
        </Flex>
